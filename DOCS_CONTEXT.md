...
| `brazil/12_accounts.md` | Accounts & Balance | 🇧🇷 Brazil |
...
| `payment_api_guidesv1.0/20_accounts.md` | Accounts & Balance | 🇦🇷 Argentina |
...
5. **New pages**: ask the user whether it's Argentina, Brazil, or Common before creating.
